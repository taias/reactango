...
export function UserDetails() {
  ...
  useEffect(() => {
    if (user) {
      ...
      setFieldValue('favorite_food', user.favorite_food || '');
    }
  }, [user, setFieldValue]);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setErrorMessage(err.message || 'ユーザー情報の更新に失敗しました');
          ...
          >
            ...
            <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
              ...
              <TextField
                ...
                label="好きな食べ物"
                name="favorite_food"
                value={isEditing ? values.favorite_food : (user.favorite_food || '-')}
                onChange={handleChange}
                disabled={!isEditing}
                variant={isEditing ? 'outlined' : 'filled'}
